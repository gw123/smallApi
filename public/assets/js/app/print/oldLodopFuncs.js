...
**************************/
        var strHtml1="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='/static/js/v1.0/print/install_lodop.exe'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
        var strHtml2="<br><font color='#FF00FF'>打印控件需要升级!点击这里<a href='/static/js/v1.0/print/install_lodop.exe'>执行升级</a>,升级后请重新进入。</font>";
	...
	try{	     
	     ...
	     //*****如下空白位置适合调用统一功能:*********	     
		//LODOP.SET_LICENSES("","583901061034998110111561289003","688858710010010811411756128900","");
		LODOP.SET_LICENSES("般若天成（北京）科技有限公司","658685962717475919278901905623","","");
	     //*******************************************
	     return LODOP; 
	}
	catch(err)
